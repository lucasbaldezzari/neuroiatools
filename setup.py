...
# Encuentra automáticamente los archivos en 'neuroiatools/datasets/erders'
def find_package_data():
    package_data = {}
    base_path = os.path.join("neuroiatools", "datasets", "erders")
...
setup(
    ...
    package_data=find_package_data(),  # Agrega los archivos de erders
